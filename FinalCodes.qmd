...
```{r}
model2 <- lm(Library_Y ~ Grade + category_code_E + category_code_M + category_code_H, data = data)
summary(model2)
```

```{r}
model3 <- lm(Library_Y ~ Grade + category_code_E + category_code_M + category_code_H + Police_Response_Y, data = data)
summary(model3)
```
